"""Training utilities for the Atom of Thoughts (AOT) reasoning module."""
...
def load_aot_training_data(limit: int | None = None) -> List[dspy.Example]:
...
def train_aot_module(
    *,
    ...
    trainset = load_aot_training_data(limit=num_examples)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train the AtomOfThoughts module")
